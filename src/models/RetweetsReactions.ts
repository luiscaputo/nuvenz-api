...
@Entity("retweetsReactions", { schema: "nuvenz_api" })
export class RetweetsReactions {
  ...
  @ManyToOne(() => Tweets, (tweets) => tweets.retweetsReactions, {
    onDelete: "RESTRICT",
    onUpdate: "RESTRICT",
  })
  ...
  @ManyToOne(() => Users, (users) => users.retweetsReactions, {
    onDelete: "RESTRICT",
    onUpdate: "RESTRICT",
  })
